...
func (fakePolicyClient) FindServiceByName(_ context.Context, name string) (*pce.Service, error) {
	return &pce.Service{Href: "/orgs/1/sec_policy/draft/services/all", Name: name}, nil
}
