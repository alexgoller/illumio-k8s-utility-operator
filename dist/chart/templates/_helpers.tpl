...
*/}}
{{- define "illumio-k8s-utility-operator.name" -}}
...
*/}}
{{- define "illumio-k8s-utility-operator.fullname" -}}
...
*/}}
{{- define "illumio-k8s-utility-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "illumio-k8s-utility-operator.resourceName" -}}
{{- $fullname := include "illumio-k8s-utility-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "illumio-k8s-utility-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "illumio-k8s-utility-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
